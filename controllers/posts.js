...
export const createPost = async (req, res) => {
   const post = req.body;
   const newPost = new PostMesssage({ ...post, creator: req.userId, createdAt: new Date().toISOString() });
...
export const updatePost = async (req, res) => {
    ...
    const updatedPost = await PostMesssage.findByIdAndUpdate(id, post, { new: true });
...
export const deletePost = async (req, res) => {
    ...
    await PostMesssage.findByIdAndRemove(id);
